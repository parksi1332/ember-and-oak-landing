  ...
  return (
    <div ref={ref} className="ig ig3">
      ...
      <div className="ig3__legend">
        <span><i className="ig3__swatch" style={{ background: "var(--brew-under)" }} /> {ig3.under} &lt;{ig3.tempMin}°C</span>
        <span><i className="ig3__swatch" style={{ background: "var(--brew-optimal)" }} /> {ig3.optimal} {ig3.tempMin}~{ig3.tempMax}°C</span>
        <span><i className="ig3__swatch" style={{ background: "var(--brew-over)" }} /> {ig3.over} &gt;{ig3.tempMax}°C</span>
      </div>
